...
public class EmployeeWrapper implements Employee, ModelWrapper<Employee> {
    ...
    */
    ...
    public int compareTo(com.test.portlets.model.Employee employee) {
    ...
    public com.liferay.portal.model.CacheModel<com.test.portlets.model.Employee> toCacheModel() {
        return _employee.toCacheModel();
    }

    public com.test.portlets.model.Employee toEscapedModel() {
        return new EmployeeWrapper(_employee.toEscapedModel());
    }

    public com.test.portlets.model.Employee toUnescapedModel() {
