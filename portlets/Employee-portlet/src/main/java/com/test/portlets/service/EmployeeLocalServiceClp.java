...
public class EmployeeLocalServiceClp implements EmployeeLocalService {
	...
	public EmployeeLocalServiceClp(InvokableLocalService invokableLocalService) {
		...
		_methodParameterTypes14 = new String[] { "com.test.portlets.model.Employee" };
		...
		_methodName20 = "listAllEmployees";

		_methodParameterTypes20 = new String[] {};

		_methodName21 = "findEployeeBySBID";

		_methodParameterTypes21 = new String[] { "java.lang.Long" };

		_methodName22 = "removeEmployee";
	...
	public com.test.portlets.model.Employee addEmployee(
		...
		return (com.test.portlets.model.Employee) ClpSerializer
	...
	public com.liferay.portal.kernel.dao.orm.DynamicQuery dynamicQuery() {
		...
		return (com.liferay.portal.kernel.dao.orm.DynamicQuery) ClpSerializer
				.translateOutput(returnObj);
	}
	...
	public java.util.List dynamicQuery(
		...
		try {
			returnObj = _invokableLocalService
					.invokeMethod(_methodName5, _methodParameterTypes5,
							new Object[] { ClpSerializer
									.translateInput(dynamicQuery) });
		} catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public long dynamicQueryCount(
		...
		try {
			returnObj = _invokableLocalService
					.invokeMethod(_methodName8, _methodParameterTypes8,
							new Object[] { ClpSerializer
									.translateInput(dynamicQuery) });
		} catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public com.liferay.portal.model.PersistedModel getPersistedModel(
		...
		try {
			returnObj = _invokableLocalService
					.invokeMethod(_methodName11, _methodParameterTypes11,
							new Object[] { ClpSerializer
									.translateInput(primaryKeyObj) });
		} catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
		...
		return (com.liferay.portal.model.PersistedModel) ClpSerializer
				.translateOutput(returnObj);
	}
	...
	public java.util.List<com.test.portlets.model.Employee> getEmployees(
		...
		return (java.util.List<com.test.portlets.model.Employee>) ClpSerializer
				.translateOutput(returnObj);
	}
	...
	public void setBeanIdentifier(java.lang.String beanIdentifier) {
		try {
			_invokableLocalService
					.invokeMethod(_methodName17, _methodParameterTypes17,
							new Object[] { ClpSerializer
	...
	public com.test.portlets.model.Employee updateEmployee(
		...
		try {
			...
			if (t instanceof com.test.portlets.NoSuchEmployeeException) {
				throw (com.test.portlets.NoSuchEmployeeException) t;
			}
	...
	public java.util.List<com.test.portlets.model.Employee> findEployeeBySBID(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName21,
					...
					new Object[] { ClpSerializer.translateInput(sbId) });
		} catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
