...
import com.test.portlets.model.EmployeeClp;
...
public class ClpSerializer {
    ...
    public static Object translateOutput(BaseModel<?> oldModel) {
        ...
        if (oldModelClassName.equals(
                    "com.test.portlets.model.impl.EmployeeImpl")) {
    ...
    public static Throwable translateThrowable(Throwable throwable) {
        ...
        if (className.equals("com.test.portlets.NoSuchEmployeeException")) {
            return new com.test.portlets.NoSuchEmployeeException();
        }
