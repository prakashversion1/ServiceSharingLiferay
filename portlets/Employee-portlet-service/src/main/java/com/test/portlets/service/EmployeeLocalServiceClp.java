...
public class EmployeeLocalServiceClp implements EmployeeLocalService {
    ...
    public com.test.portlets.model.Employee addEmployee(
        ...
        return (com.test.portlets.model.Employee) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public java.util.List<com.test.portlets.model.Employee> getEmployees(
        ...
        return (java.util.List<com.test.portlets.model.Employee>) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public com.test.portlets.model.Employee updateEmployee(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName19,
                    ...
                    new Object[] { ClpSerializer.translateInput(employee), empId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
